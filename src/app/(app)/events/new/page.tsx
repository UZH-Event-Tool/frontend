const formFields = [
  ...
  },
  {
    ...
    name: "category",
    type: "text",
    placeholder: "Networking / Culture / Outdoors",
  },
  {
    label: "Event theme",
    name: "theme",
    ...
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-6">
      ...
      <form className="space-y-6 rounded-3xl border border-transparent bg-white/90 p-8 shadow-[0_20px_50px_rgba(90,84,255,0.15)]">
        ...
        <fieldset className="space-y-2">
          ...
          <div className="flex min-h-[140px] items-center justify-center rounded-3xl border border-dashed border-[#dcd9ff] bg-[#fafafa] text-sm text-gray-500">
