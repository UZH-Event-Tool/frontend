    ...
    <div className="flex flex-col gap-6">
      ...
      <section className="grid gap-6 lg:grid-cols-[2fr_1fr]">
        ...
        <aside className="space-y-4 rounded-3xl border border-transparent bg-white/90 p-6 shadow-[0_20px_50px_rgba(90,84,255,0.15)]">
          ...
          <div className="rounded-2xl border border-dashed border-[#dcd9ff] bg-[#f8f7ff] p-4 text-sm text-gray-500">
            RSVP graph or attendee list will appear here once the data layer is
            connected.
          </div>
          <Link
            href={`/events/${eventId}/edit`}
            className="inline-flex items-center justify-center rounded-full border border-transparent bg-[#f3f5ff] px-5 py-2 text-sm font-semibold text-indigo-600 shadow-inner transition hover:bg-[#ece8ff]"
          >
            Edit Event
          </Link>
        </aside>
